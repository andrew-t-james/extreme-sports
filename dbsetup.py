...
summer_sport2 = Sports(user_id=1, name="BMX Vert",
                       description="The earliest photographic documentation of BMX freestyle shows [1] Devin and Todd Bank in 1974 riding BMX bikes on an eight foot tall skateboard ramp they built at their childhood home in West Los Angeles, California. This was the birth of BMX ramp riding. Devin Bank was also documented doing [2] 360 degree freestyle spinning tricks on the street and also in the air by jumping off curbs. Skateboarder Magazine then published photos of kids on bikes riding in empty household swimming pools in 1975.", description_link="https://en.wikipedia.org/wiki/Freestyle_BMX#Vert_Ramp", image_link="http://www.promotocross.com/sites/default/files/styles/gallery_small/public/images/gallery/photos/doug-bmx-vert-final-640x370.jpg?itok=nnhd9_fr", category=category2)
